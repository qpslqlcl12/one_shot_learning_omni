...
def network_initializer():   
    ...
    ini_w3=tf.Variable(tf.random.uniform([2000,500],-1,1), trainable=True)
    ini_w4=tf.Variable(tf.random.uniform([500,100],-1,1), trainable=True)
    ini_w5=tf.Variable(tf.random.uniform([100,25],-1,1), trainable=True)
